...
gcf_tree = ggtree(turtle_tree, size=0.8, ladderize=F) +#, aes(color=full_data$Family)) +
  ...
  geom_cladelabel(node=36, label="Emydidae", align=T, color=famcol, offset=famoffset) +
  geom_cladelabel(node=33, label="Testudinidae", align=T, color=famcol, offset=famoffset) +
  geom_cladelabel(node=30, label="Geomydidae", align=T, color=famcol, offset=famoffset) +
...
gcf_tree = ggtree(topo_tree_used, size=0.8, ladderize=F) +#, aes(color=full_data$Family)) +
  ...
  geom_cladelabel(node=31, label="Emydidae", align=T, color=famcol, offset=famoffset) +
  geom_cladelabel(node=29, label="Testudinidae", align=T, color=famcol, offset=famoffset) +
  geom_cladelabel(node=27, label="Geomydidae", align=T, color=famcol, offset=famoffset) +
