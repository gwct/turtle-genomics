...
```{r read-annotation-data, out.width="75%", fig.align = "center", warning=FALSE, eval=F}

annotated_specs = c("Cabingdonii", "Cmydas", "Cpicta", "Cserpentina", "Gagassizi", "Pcastaneus", "Pmegacephalum", "Psinensis", "Tcarolina")
...
```{r add-feature-counts, out.width="75%", fig.align = "center", warning=FALSE, eval=F}
